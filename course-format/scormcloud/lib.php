...
function callback_scormcloud_definition() {
    return get_string('scormcloud');
}

function callback_scormcloud_request_key() {
    return 'scormcloud';
}

function callback_scormcloud_display_content() {
    return false;
}
