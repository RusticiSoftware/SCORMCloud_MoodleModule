<?php // $Id: format.php,v 1.12.2.1 2007-10-22 06:54:40 nfreear Exp $
    ...
    $rmax = (empty($THEME->block_r_max_width)) ? 0 : $THEME->block_r_max_width;
    ...
    echo '<table id="layout-table" width="100%" cellspacing="0" summary="'.get_string('layouttable').'">';
    echo '<tr>';
    ...
    if (function_exists($moduleformat)) {
        ...
        notify('The module '. $module. ' does not support this stuff...');
    }
    echo '</td>';
/*
    // The right column
