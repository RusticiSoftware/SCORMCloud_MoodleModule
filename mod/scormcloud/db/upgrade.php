...
/// for demonstrative purposes and to show how the scormcloud
/// iself has been upgraded.

/// For each upgrade block, the file scormcloud/version.php
...
/// First example, some fields were added to install.xml on 2007/04/01
    ...
    /// Define field course to be added to scormcloud
    ...
    /// Define field intro to be added to scormcloud
        $table = new xmldb_table('scormcloud');
    ...
    /// Define field introformat to be added to scormcloud
        $table = new xmldb_table('scormcloud');
...
/// "01" in the last two digits of the version
    ...
    /// Define field timecreated to be added to scormcloud
        $table = new xmldb_table('scormcloud');
    ...
    /// Define field timemodified to be added to scormcloud
        $table = new xmldb_table('scormcloud');
    ...
    /// Define index course (not unique) to be added to scormcloud
        $table = new xmldb_table('scormcloud');
