...
* Edit all the files in this directory and its subdirectories and change
  all the instances of the string "scormcloud" to your module name
  (eg "widget"). If you are using Linux, you can use the following command
  $ find . -type f -exec sed -i 's/scormcloud/widget/g' {} \;

* Rename the file lang/en_utf8/scormcloud.php to lang/en_utf8/widget.php
...
* Go to Site Administration > Plugins > Activity modules > Manage activities
  and you should find that this scormcloud has been added to the list of
  installed modules.
